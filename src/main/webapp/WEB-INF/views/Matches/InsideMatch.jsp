			...
			<%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
				<%@ taglib prefix="ocaParchis" tagdir="/WEB-INF/tags" %>
					...
					<body style="background-color:#ececec">
						...
						<div style="margin-top: 2%;margin-right: 5%; height: 80%;  position:absolute;left: 72%;; right: 0%;overflow-y: scroll;scroll-behavior: smooth; background-color: #e6e6e6; border: 2px #222222; border-style:solid ">
