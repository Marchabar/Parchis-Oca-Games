...
<ocaParchis:layout pageName="home">
	...
	<body style="background-color:#ececec">
		...
		<div style="display: inline-block; width: 100%;">
			...
			<div style="margin-right: 15%; width: 20%;height: 65%;  position: absolute;right: 0;overflow-y: scroll;scroll-behavior: smooth; background-color: #e6e6e6; border: 2px #222222; border-style:solid;float:left ">
